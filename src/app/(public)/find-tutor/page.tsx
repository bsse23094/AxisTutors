...
const mockTutors = [
  ...
  { id: '3', username: 'hassan-ali', full_name: 'Sofia Martinez', avatar: 'SM', bio: 'Full-stack developer and CS educator. I teach programming concepts, data structures, and web development with hands-on projects.', hourly_rate: 2500, rating_avg: 5.0, total_sessions: 156, subjects: [{ name: 'Computer Science', level: 'University' }], city: 'Islamabad' },
  { id: '4', username: 'ayesha-malik', full_name: 'Zara Ahmed', avatar: 'ZA', bio: 'English language expert specializing in IELTS and academic writing. Over 200 students coached to Band 7+ scores.', hourly_rate: 1500, rating_avg: 4.7, total_sessions: 189, subjects: [{ name: 'English', level: 'All' }, { name: 'IELTS Prep', level: 'All' }], city: 'Lahore' },
  { id: '5', username: 'usman-tariq', full_name: 'Leo Nakamura', avatar: 'LN', bio: 'Economics and Accounting tutor with a CA background. I simplify complex business concepts for commerce students.', hourly_rate: 1700, rating_avg: 4.9, total_sessions: 275, subjects: [{ name: 'Economics', level: 'A-Level' }, { name: 'Accounts', level: 'FSc' }], city: 'Rawalpindi' },
  { id: '6', username: 'sara-qureshi', full_name: 'Aria Patel', avatar: 'AP', bio: 'STEMS specialist. Former Cambridge examiner with deep knowledge of the SABIS curriculum and exam patterns.', hourly_rate: 2200, rating_avg: 4.8, total_sessions: 198, subjects: [{ name: 'O-Level Maths', level: 'O-Level' }], city: 'Karachi' },
  ...
  { id: '8', username: 'maria-hassan', full_name: 'Maya Singh', avatar: 'MS', bio: 'English Literature and Creative Writing expert with a passion for helping students ace their board exams with focused preparation.', hourly_rate: 1200, rating_avg: 4.5, total_sessions: 110, subjects: [{ name: 'Urdu', level: 'Matric' }, { name: 'Pak Studies', level: 'All' }], city: 'Multan' },
]
