...
const mockTutors = [
  { id: '1', username: 'ahmed-khan', full_name: 'Ethan Carter', avatar: 'EC', bio: 'Experienced Physics and Mathematics tutor with 10+ years of teaching in Ontario and Alberta. I help students build strong conceptual foundations.', rating_avg: 4.9, total_sessions: 342, subjects: [{ name: 'Physics', level: 'FSc' }, { name: 'Mathematics', level: 'All' }], city: 'Lahore' },
  { id: '2', username: 'fatima-noor', full_name: 'Ayaan Khan', avatar: 'AK', bio: 'Chemistry and Biology specialist with an MSc in Biochemistry. Passionate about making science fun and accessible for students at all levels.', rating_avg: 4.8, total_sessions: 218, subjects: [{ name: 'Chemistry', level: 'O-Level' }, { name: 'Biology', level: 'All' }], city: 'Karachi' },
  { id: '3', username: 'hassan-ali', full_name: 'Sofia Martinez', avatar: 'SM', bio: 'Full-stack developer and CS educator. I teach programming concepts, data structures, and web development with hands-on projects.', rating_avg: 5.0, total_sessions: 156, subjects: [{ name: 'Computer Science', level: 'University' }], city: 'Islamabad' },
  { id: '4', username: 'ayesha-malik', full_name: 'Zara Ahmed', avatar: 'ZA', bio: 'English language expert specializing in IELTS and academic writing. Over 200 students coached to Band 7+ scores.', rating_avg: 4.7, total_sessions: 189, subjects: [{ name: 'English', level: 'All' }, { name: 'IELTS Prep', level: 'All' }], city: 'Lahore' },
  { id: '5', username: 'usman-tariq', full_name: 'Leo Nakamura', avatar: 'LN', bio: 'Economics and Accounting tutor with a CA background. I simplify complex business concepts for commerce students.',  rating_avg: 4.9, total_sessions: 275, subjects: [{ name: 'Economics', level: 'A-Level' }, { name: 'Accounts', level: 'FSc' }], city: 'Rawalpindi' },
  { id: '6', username: 'sara-qureshi', full_name: 'Aria Patel', avatar: 'AP', bio: 'STEMS specialist. Former Cambridge examiner with deep knowledge of the SABIS curriculum and exam patterns.', rating_avg: 4.8, total_sessions: 198, subjects: [{ name: 'O-Level Maths', level: 'O-Level' }], city: 'Karachi' },
  { id: '7', username: 'rizwan-ahmed', full_name: 'Daniel Schmidt', avatar: 'DS', bio: 'Statistics and Mathematics tutor with 8 years of teaching experience. I focus on exam preparation and problem-solving techniques.', rating_avg: 4.6, total_sessions: 145, subjects: [{ name: 'Statistics', level: 'FSc' }, { name: 'Mathematics', level: 'Matric' }], city: 'Faisalabad' },
  { id: '8', username: 'maria-hassan', full_name: 'Maya Singh', avatar: 'MS', bio: 'English Literature and Creative Writing expert with a passion for helping students ace their board exams with focused preparation.', rating_avg: 4.5, total_sessions: 110, subjects: [{ name: 'Urdu', level: 'Matric' }, { name: 'Pak Studies', level: 'All' }], city: 'Multan' },
]
